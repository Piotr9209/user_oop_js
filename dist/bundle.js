...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // 3) Stwórz strukturę danych związaną z użytkownikami.
...
var Validation = function () {
    ...
    _createClass(Validation, null, [{
        ...
        value: function isEmail(email) {
            if (!_is_js2.default.email(email)) throw new Error("is wrong email");
        }
    }, {
        key: "isPassword",
        value: function isPassword(password) {
            _is_js2.default.setRegexp(/^(?=.*\d)(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z]).{8,}$/, 'alphaNumeric');
            if (!_is_js2.default.alphaNumeric(password)) throw new Error('is wrong password');
        }
    }, {
        key: "isSex",
        value: function isSex(sex) {
            if (!_is_js2.default.inArray(sex, ["male", "female"])) throw new Error("is wrong sex");
        }
    }, {
        key: "isEntryLevel",
        value: function isEntryLevel(entryLevel) {
            if (!_is_js2.default.inArray(entryLevel, ["user", "admin"])) throw new Error("is wrong type user");
        }
    }, {
        key: "isEmpty",
        value: function isEmpty(value) {
            if (_is_js2.default.empty(value)) throw new Error("name and surname must be the min 1 characters");
        }
    }, {
        key: "isUser",
        value: function isUser(value) {
...
var User = function () {
    function User(name, surname, email, password, dateOfBirth, sex) {
        var entryLevel = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'user';
        ...
        this.dateRegistration = (0, _moment2.default)().format("DD/MM/YYYY");
        this.name = name;
        this.surname = surname;
        this.dateOfBirth = (0, _moment2.default)(dateOfBirth, ['MM.DD.YYYY', 'DD.MM.YYYY', 'YYYY.MM.DD', 'YYYY.DD.MM']).format('DD/MM/YYYY');
...
var Admin = function (_User) {
    ...
    function Admin(name, surname, email, password, dateOfBirth, sex) {
        var entryLevel = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'admin';

        _classCallCheck(this, Admin);

        return _possibleConstructorReturn(this, (Admin.__proto__ || Object.getPrototypeOf(Admin)).call(this, name, surname, email, password, dateOfBirth, sex, entryLevel = 'admin'));
    }

    _createClass(Admin, [{
        key: "changePasswordUser",
        value: function changePasswordUser(user, password) {
...
var user2 = new User("piotr", "gdula", "piotr@gmail.com", "Qwer12342?!", "20.03.1990", 'male');

var admin = new Admin("jan", "kowalski", "jan@gmail.com", "Qwer1234?!", "19.02.1988", "female");
